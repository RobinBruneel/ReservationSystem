...
skel.registerPlugin("layers", function (e) {
    ...
    return typeof e == "undefined" ? P : (e.fn[Tt] = function () {
    ...
    }, an[k][yt] = {"top-left": {v: j, h: L, side: L}, "top-right": {v: j, h: g, side: g}, top: {v: j, h: T, side: j}, "top-center": {v: j, h: T, side: j}, "bottom-left": {v: y, h: L, side: L}, "bottom-right": {v: y, h: g, side: g}, bottom: {v: y, h: T, side: y}, "bottom-center": {v: y, h: T, side: y}, left: {v: T, h: L, side: L}, "center-left": {v: T, h: L, side: L}, right: {v: T, h: g, side: g}, "center-right": {v: T, h: g, side: g}}, an[k][at] = {none: {activate: function (e) {
                var t = e[n], r = e[s];
        ...
        if (!r[C] || !(r[C]in this[yt]))
            r[C] = "top-left";
        r[Yt] || (r[Yt] = this[yt][r[C]][Yt]);
        if (!r[tt] || typeof r[tt] != "object" && !(r[tt]in this[at]))
            r[tt] = mt;
        r.clickToClose && o[wt]("a")[x](it, It).on("click.skel-layers", function (r) {
            ...
            if (r.swipeToClose) {
                ...
                if (a)
                    return u[rt] = A, u[nt] = A, u[E](), P
            }
            if (o[w]() == 0 && n < 0 || s > i - 2 && s < i + 2 && n > 0)
                return P
        }), this[s] = o
    }, t = {config: {baseZIndex: 1e4, transform: kt, transformBreakpoints: A, transformTest: A, speed: 250, layers: {}}, cache: {layers: {}, body: A, window: A, wrapper: A, inactiveWrapper: A, activeWrapper: A, exclusiveLayer: A}, eventType: $t, getBaseFontSize: function () {
            ...
            t[n][tn] && (t[n][U] = t[n][tn]());
            if (t[n][U]) {
                if (t._[zt][F] == rn && t._[zt].deviceVersion < 4 || t._[zt][F] == "wp")
                    t[n][U] = P;
